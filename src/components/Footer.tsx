...
const Footer = () => {
  return (
    <footer className="bg-card mt-auto pt-12 pb-6 border-t border-border">
      <div className="container">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <Tv className="h-6 w-6 text-iptv-500" />
              <span className="font-bold text-xl text-foreground">StreamWave</span>
            </Link>
            <p className="text-sm text-muted-foreground mb-4">
              The ultimate IPTV streaming platform with the best channels from around the world.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/live" className="text-muted-foreground hover:text-foreground transition-colors">Live TV</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/licensing" className="text-muted-foreground hover:text-foreground transition-colors">Licensing</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground mb-4 md:mb-0">
            © {new Date().getFullYear()} StreamWave. All rights reserved.
          </p>
